...
| 1024×1024 | 20 | 默认档 |
| 1024×576 | 20 | 16:9 |
| 1344×768 | 10 | **比赛片推荐**（超过 1280×720 硬指标） |
...
|---|---|
| 1024×1024 | 默认 |
| 1440×720 | 16:9，**符合比赛硬指标** |

### 图像 `CogView-4`（付费，质量高）
- **首个能可靠生成汉字的开源文生图模型**
- 适合需要中文标语/书法的镜头

⚠️ **已确认问题**：免费档出图右下角带"AI 生成"水印（URL 域名 `maas-watermark-prod-new`，文件名含 `_watermark.png`）。**不能直接投比赛**——只能作概念图/风格参考，或后期去水印。
...
| 优势 | **原生 1920×1080 16:9，无 Agnes 的 4:3 裁切放大问题**，直接超比赛硬指标 |
